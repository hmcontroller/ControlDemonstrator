...
def run():
    ...
    controlledParameterCount = len(requestedControlledParams)
    ...
    availableControledParameterCount = len(availableControlledParameters)
    ...
    with open(C_CONFIG_FILE_PATH, "w") as f:
        ...
        f.write("#define {:{nameWidth}} {:>{valueWidth}}\n".format(
            "CONTROLLED_PARAMETER_COUNT", availableControledParameterCount, nameWidth=nameWidth, valueWidth=valueWidth))
        f.write("#define {:{nameWidth}} {:>{valueWidth}}\n".format(
            "REQUESTED_CONTROLLED_PARAMETER_COUNT", controlledParameterCount, nameWidth=nameWidth, valueWidth=valueWidth))
